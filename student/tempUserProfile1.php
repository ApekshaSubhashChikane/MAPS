                      ...
                      <div id="editDiv" style="display:none">
                          <form method="POST" action="../backend/userdata.php" class="form-horizontal" role="form">
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="lastName">Last Name:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="lastName"  value="<?php echo $lastName;?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="firstName">First Name:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="firstName" value="<?php echo $firstName?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="middleName">Middle Name:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="middleName" value="<?php echo $middleName?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="nationality">Nationality:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="nationality" value="<?php echo $nationality?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="gender">Gender:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="gender" value="<?php echo $gender?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="birthDate">Birthdate:</label>
                            ...
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="birthPlace">Birthplace:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="birthPlace" value="<?php echo $birthPlace?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="presStreetAddr">Present Street Address:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="presStreetAddr" value="<?php echo $presStreetAddr?>"required >
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="presProvCity">Present City:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="presProvCity" value="<?php echo $presProvCity?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="presRegion">Present Region:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="presRegion" value="<?php echo $presRegion?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="permStreetAddr">Permanent Street Address:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="permStreetAddr" value="<?php echo $permStreetAddr?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="permProvCity">Permanent City:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="permProvCity" value="<?php echo $permProvCity?>" required>
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="permRegion">Permanent Region:</label>
                              <div class="col-sm-10">
                                <input type="name" class="form-control" name="permRegion" value="<?php echo $permRegion?>" required >
                              </div>
                            </div>
                            <div class="form-group">
                              <label class="control-label col-sm-2" for="contactNo">Contact Number:</label>
