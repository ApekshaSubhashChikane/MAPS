    ...
    <div id = "page-wrapper">
      <!-- Header -->
        ...
        <div class="mySlides fade">
          ...
          <img src="Symbiosis.jpg">
          <div class="text"></div>
        </div>
        <div class="mySlides fade">
          <div class="numbertext">2 / 3</div>
          <img src="symbilogo.jpg">
          <div class="text"></div>
        </div>
        <div class="mySlides fade">
          <div class="numbertext">3 / 3</div>
          <img src="MAPS logo.png">
          <div class="text"></div>
        </div>
        </div>
        <br>
          ...
          <section class="wrapper style3 container special">
            ...
            <div class="row">
              <div class="6u 12u(narrower)">
                <section>
                  <a href="#" class="image featured"><img src="merit-based-scholarship.jpg" alt="11" /></a>
                  <header>
              ...
              <div class="6u 12u(narrower)">
                <section>
                  <a href="#" class="image featured"><img src="PHYSICALLY-CHALLENGED-SCHOLARSHIPS.jpg" alt="22" /></a>
                  <header>
