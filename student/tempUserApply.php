    ...
    <div id = "page-wrapper">
              ...
              <div class="row">
                <div class="4u 12u(narrower)">
                  ...
                  <section>
                    ...
                    <p>Academic achievement, financial need, extracurricular involvement, community service, and specific talents or interests. Scholarships can be a valuable resource for students looking to pursue higher education, as they do not need to be repaid, unlike student loans.</p>
                    <footer>
                      <ul class="buttons">
                ...
                <div class="4u 12u(narrower)">
                  ...
                  <section>
                    ...
                    <p>These scholarships are awarded based on academic achievement, standardized test scores, or other specific accomplishments. They recognize excellence in academics, athletics, or other areas.</p>
                   <br><br> <footer>
                      <ul class="buttons">
                        <li><a href="#" class="button small">Learn More</a></li>
                      </ul>
                ...
                <div class="4u 12u(narrower)">
                  ...
                  <section>
                    <header>
                      <h3>Specific Interest Scholarships</h3>
                    </header>
                    <p>Some scholarships are offered to students with particular interests, talents, or career goals. These may include scholarships for musicians, artists, athletes, or students pursuing specific fields of study.</p>
                    <br><footer>
                      <ul class="buttons">
                        <li><a href="#" class="button small">Learn More</a></li>
                      </ul>
      ...
      <!-- Footer -->
        <footer id="footer">
          ...
          <ul class="copyright">
            <li>&copy; MAPS Scholarship Management System</li>
          </ul>
